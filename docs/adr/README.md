...
| [0002](0002-character-document-store.md) | Align the character stack with PSD-0001, breaking it where needed | Proposed (v0.3) |
| [0003](0003-generated-types-as-representation.md) | Generated schema types are the in-memory representation | Proposed (v0.2) |
