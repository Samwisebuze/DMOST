...
Records 0002–0009 all descend from `docs/psd/0001_character-management-tui.md` and are meant to be read
against it: the PSD carries the product decisions D1–D21, these carry the ones that span packages,
